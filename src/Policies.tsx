  ...
  return (
    <div style={{ maxWidth: '900px' }}>
      ...
      <ul style={{ marginBottom: '16px' }}>
        ...
        <li><Text>Receive notifications about events and platform updates</Text></li>
        <li><Text>Report inappropriate content or behavior</Text></li>
      </ul>
      ...
      <ul style={{ marginBottom: '16px' }}>
        ...
        <li><Text>Create events that are not legitimate community service opportunities</Text></li>
      </ul>
      ...
      <ul style={{ marginBottom: '16px' }}>
        ...
        <li><Text>Not discriminate based on race, gender, religion, disability, or other protected characteristics</Text></li>
      </ul>
      ...
      <Title3 style={{ marginTop: '16px', marginBottom: '12px' }}>5.2 Content Standards</Title3>
      <Text style={{ display: 'block', marginBottom: '16px' }}>
        All content you post must:
      </Text>
      <ul style={{ marginBottom: '16px' }}>
        <li><Text>Be accurate and truthful</Text></li>
        <li><Text>Not contain profanity, hate speech, or discriminatory language</Text></li>
        <li><Text>Not contain spam, scams, or misleading information</Text></li>
        <li><Text>Not violate any third party's rights (copyright, trademark, privacy)</Text></li>
        <li><Text>Comply with our automated content filtering rules</Text></li>
      </ul>

      <Title3 style={{ marginTop: '16px', marginBottom: '12px' }}>5.3 Our Rights</Title3>
      <Text style={{ display: 'block', marginBottom: '16px' }}>
        We reserve the right to:
      </Text>
      <ul style={{ marginBottom: '16px' }}>
        <li><Text>Remove any content that violates these Terms or is otherwise objectionable, without notice</Text></li>
        <li><Text>Automatically hide posts that receive 3 or more reports pending review</Text></li>
        <li><Text>Modify or remove content that triggers our content filtering system</Text></li>
        <li><Text>Suspend or terminate accounts that violate these Terms</Text></li>
      </ul>

      <Title3 style={{ marginTop: '16px', marginBottom: '12px' }}>5.4 Platform Ownership</Title3>
      <Text style={{ display: 'block', marginBottom: '16px' }}>
        The Platform, including its design, code, features, and trademarks, is owned by us and protected by copyright and other intellectual property laws. You may not copy, modify, or reverse engineer any part of the Platform.
      </Text>
      ...
      <Text style={{ display: 'block', marginBottom: '16px', fontWeight: 'bold' }}>
        Important: Attendance records on this Platform are managed by event organizers. We do not independently verify attendance.
      </Text>

      <Title3 style={{ marginTop: '16px', marginBottom: '12px' }}>6.1 How Attendance Works</Title3>
      <ul style={{ marginBottom: '16px' }}>
        <li><Text>Event organizers are solely responsible for marking accurate attendance</Text></li>
        <li><Text>Only organizers can check in participants for their own events</Text></li>
        <li><Text>Attendance records are permanently saved to your profile once marked</Text></li>
        <li><Text>You can view your complete attendance history in your profile</Text></li>
      </ul>

      <Title3 style={{ marginTop: '16px', marginBottom: '12px' }}>6.2 Limitations and Disclaimers</Title3>
      <ul style={{ marginBottom: '16px' }}>
        <li><Text>Attendance records are intended for personal tracking purposes</Text></li>
        <li><Text>We do not guarantee that attendance records will be accepted by schools, organizations, or institutions for official purposes</Text></li>
        <li><Text>We are not responsible for organizers marking inaccurate attendance</Text></li>
        <li><Text>Users should obtain additional verification if required for official purposes</Text></li>
      </ul>

      <Title3 style={{ marginTop: '16px', marginBottom: '12px' }}>6.3 Falsifying Records</Title3>
      <Text style={{ display: 'block', marginBottom: '16px' }}>
      ...
      <ul style={{ marginBottom: '16px' }}>
        ...
        <li><Text>Filtered content includes profanity, spam indicators, scams, harassment, and threats</Text></li>
        <li><Text>Real-time analysis of event titles and descriptions</Text></li>
      </ul>

      <Title3 style={{ marginTop: '16px', marginBottom: '12px' }}>7.2 User Reporting</Title3>
      <Text style={{ display: 'block', marginBottom: '16px' }}>
        Users can report problematic content for review:
      </Text>
      <ul style={{ marginBottom: '16px' }}>
        <li><Text>Report categories: Inappropriate Content, Spam, Safety Concerns, Terms Violation, No-Show Issues, Other</Text></li>
        <li><Text>You can submit up to 5 reports per day</Text></li>
        <li><Text>You cannot report the same user within 24 hours</Text></li>
        <li><Text>Posts with 3+ pending reports are automatically hidden pending review</Text></li>
      </ul>

      <Title3 style={{ marginTop: '16px', marginBottom: '12px' }}>7.3 Consequences of Violations</Title3>
      <ul style={{ marginBottom: '16px' }}>
        ...
        <li><Text>Serious violations may be reported to law enforcement</Text></li>
      </ul>
      ...
      <ul style={{ marginBottom: '16px' }}>
        ...
        <li><Text>That all events posted are legitimate or will occur as described</Text></li>
      </ul>
      ...
      <ul style={{ marginBottom: '16px' }}>
        ...
        <li><Text>Interactions between users at events or on the Platform</Text></li>
        ...
        <li><Text>Any injuries, damages, or losses occurring at events</Text></li>
        <li><Text>Transportation to or from events</Text></li>
      </ul>

      <Title3 style={{ marginTop: '16px', marginBottom: '12px' }}>8.3 Limitation of Damages</Title3>
      <Text style={{ display: 'block', marginBottom: '16px' }}>
        To the maximum extent permitted by law, we shall not be liable for any indirect, incidental, consequential, special, or punitive damages arising from:
      </Text>
      <ul style={{ marginBottom: '16px' }}>
        <li><Text>Your use or inability to use the Platform</Text></li>
        <li><Text>Any errors or omissions in content</Text></li>
        <li><Text>Unauthorized access to your account</Text></li>
        <li><Text>Conduct of any third party on the Platform</Text></li>
        <li><Text>Loss of data, attendance records, or other information</Text></li>
      </ul>
      ...
      <ul style={{ marginBottom: '16px' }}>
        ...
        <li><Text>Your violation of any applicable laws or regulations</Text></li>
      </ul>
      ...
      <ul style={{ marginBottom: '16px' }}>
        ...
        <li><Text>False or malicious reporting</Text></li>
        <li><Text>Creating fake events or attendance records</Text></li>
        <li><Text>Extended periods of inactivity</Text></li>
        <li><Text>Any reason at our sole discretion</Text></li>
      </ul>

      <Title3 style={{ marginTop: '16px', marginBottom: '12px' }}>10.2 Effect of Termination</Title3>
      <Text style={{ display: 'block', marginBottom: '16px' }}>
        Upon termination:
      </Text>
      <ul style={{ marginBottom: '16px' }}>
        <li><Text>Your right to use the Platform will immediately cease</Text></li>
        <li><Text>Your attendance history may be retained for record-keeping purposes</Text></li>
        <li><Text>Events you created may be removed from public view</Text></li>
        <li><Text>You will no longer be able to access your account</Text></li>
      </ul>

      <Title3 style={{ marginTop: '16px', marginBottom: '12px' }}>10.3 Your Right to Terminate</Title3>
      <Text style={{ display: 'block', marginBottom: '16px' }}>
        You may request account deletion at any time by contacting us. Note that attendance records for events you attended may be retained as described in our Privacy Policy.
      </Text>

      <Title2 style={{ marginTop: '24px', marginBottom: '16px' }}>11. Beta/Development Status</Title2>
      <Text style={{ display: 'block', marginBottom: '16px' }}>
        This Platform is currently in beta and considered a development product. You acknowledge that:
      </Text>
      <ul style={{ marginBottom: '16px' }}>
        ...
        <li><Text>We are continuously improving security and functionality</Text></li>
      </ul>

      <Title2 style={{ marginTop: '24px', marginBottom: '16px' }}>12. Privacy</Title2>
      <Text style={{ display: 'block', marginBottom: '16px' }}>
        Your use of the Platform is also governed by our Privacy Policy. Please review it to understand how we collect, use, and protect your information. By using the Platform, you consent to our Privacy Policy.
      </Text>

      <Title2 style={{ marginTop: '24px', marginBottom: '16px' }}>13. Third-Party Services</Title2>
      <Text style={{ display: 'block', marginBottom: '16px' }}>
        The Platform may contain links to or integrate with third-party services (such as calendar exports to Google Calendar, Outlook, Yahoo, etc.). We are not responsible for:
      </Text>
      <ul style={{ marginBottom: '16px' }}>
        <li><Text>The content or privacy practices of third-party services</Text></li>
        <li><Text>How third-party services handle your data</Text></li>
        <li><Text>The availability or functionality of third-party services</Text></li>
      </ul>
      <Text style={{ display: 'block', marginBottom: '16px' }}>
      ...
      <Text style={{ display: 'block', marginBottom: '16px' }}>
        We may modify these Terms at any time. Material changes will be indicated by:
      </Text>
      <ul style={{ marginBottom: '16px' }}>
        <li><Text>Updating the "Last Updated" date at the top</Text></li>
        <li><Text>Displaying a notice on the Platform</Text></li>
        <li><Text>Sending an in-app notification (for significant changes)</Text></li>
      </ul>
      <Text style={{ display: 'block', marginBottom: '16px' }}>
      ...
      <Text style={{ display: 'block', marginBottom: '16px' }}>
        If you have a dispute with us, you agree to first contact us and attempt to resolve the dispute informally before pursuing any formal action.
      </Text>

      <Title3 style={{ marginTop: '16px', marginBottom: '12px' }}>15.2 Governing Law</Title3>
      <Text style={{ display: 'block', marginBottom: '16px' }}>
